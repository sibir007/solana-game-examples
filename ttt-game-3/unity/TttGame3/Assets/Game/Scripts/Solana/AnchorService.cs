...
public class AnchorService : MonoBehaviour
{
    ...
    private TttGame3Client anchorClient;
    ...
    private async void OnLogin(Account account)
    {
        ...
        anchorClient = new TttGame3Client(Web3.Rpc, Web3.WsRpc, AnchorProgramIdPubKey);
    ...
    public async Task InitAccounts(bool useSession)
    {
        ...
        var initTx = TttGame3Program.InitPlayer(accounts, levelSeed, AnchorProgramIdPubKey);
        tx.Add(initTx);
    ...
    public async void ChopTree(bool useSession, Action onSuccess)
    {
        ...
        if (useSession)
        {
            ...
            var chopInstruction = TttGame3Program.ChopTree(chopTreeAccounts, levelSeed, transactionCounter, AnchorProgramIdPubKey);
