...
using TttGame3;
using TttGame3.Program;
using TttGame3.Errors;
using TttGame3.Accounts;
...
namespace TttGame3
{
    ...
    namespace Errors
    {
        public enum TttGame3ErrorKind : uint
        {
    ...
    public partial class TttGame3Client : TransactionalBaseClient<TttGame3ErrorKind>
    {
        public TttGame3Client(IRpcClient rpcClient, IStreamingRpcClient streamingRpcClient, PublicKey programId) : base(rpcClient, streamingRpcClient, programId)
        {
        }
        ...
        {
            Solana.Unity.Rpc.Models.TransactionInstruction instr = Program.TttGame3Program.InitPlayer(accounts, levelSeed, programId);
        ...
        {
            Solana.Unity.Rpc.Models.TransactionInstruction instr = Program.TttGame3Program.ChopTree(accounts, levelSeed, counter, programId);
            return await SignAndSendTransaction(instr, feePayer, signingCallback);
        }
        ...
        {
            Solana.Unity.Rpc.Models.TransactionInstruction instr = Program.TttGame3Program.SuperChopTree(accounts, levelSeed, counter, programId);
            return await SignAndSendTransaction(instr, feePayer, signingCallback);
        }

        protected override Dictionary<uint, ProgramError<TttGame3ErrorKind>> BuildErrorsDictionary()
        {
            return new Dictionary<uint, ProgramError<TttGame3ErrorKind>>{{6000U, new ProgramError<TttGame3ErrorKind>(TttGame3ErrorKind.NotEnoughEnergy, "Not enough energy")}, {6001U, new ProgramError<TttGame3ErrorKind>(TttGame3ErrorKind.WrongAuthority, "Wrong Authority")}, };
        }
    }
    ...
    namespace Program
    {
        ...
        public static class TttGame3Program
        {
