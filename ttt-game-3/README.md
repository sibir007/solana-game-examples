...
dotnet anchorgen -i target/idl/ttt-game-3.json -o target/idl/TttGame3.cs
```

(Replace ttt-game-3 with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(TttGame3_PROGRAM_ID)
      );
    try {
