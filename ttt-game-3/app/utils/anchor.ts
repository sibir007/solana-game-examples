...
import IDL from "../idl/ttt-game-3.json";
import { TttGame3 } from "@/idl/ttt-game-3";
...
// TttGame3 game program ID
export const PROGRAM_ID = new PublicKey(IDL.address);

export function getProgram(provider: AnchorProvider) {
  return new Program(IDL as TttGame3, provider);
}
...
export type PlayerData = IdlAccounts<TttGame3>["playerData"]
export type GameData = IdlAccounts<TttGame3>["gameData"]
